# del and list methods exercises 3rd march 2024 : Do all of this in a .py file in Pycharm.
...
print("Use del to remove tiger from the list assigned to arctic_animals." + str(arctic_animals))
