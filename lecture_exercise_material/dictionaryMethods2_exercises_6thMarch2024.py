...
# "consonant" as the value for each of those keys. Only use lower case letters for the consonants.  "y" counts as a
# consonant for this exercise.  Use a for loop and the .items() method to print each of those key: value pairs on a
# different line.  For example, the first 3 lines in the output should be the following:
#
# b consonant
#
# c consonant
