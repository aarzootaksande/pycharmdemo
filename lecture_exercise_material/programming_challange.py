...
#
# Next, create a function to calculate the volume of the rectangular prism.  It should have 3 parameters representing length, width, and
# height and return the volume of a rectangular prism calculated using those 3 parameters.
#
